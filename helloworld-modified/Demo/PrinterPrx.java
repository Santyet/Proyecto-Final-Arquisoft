...
{
    default String printString(String s, long startTime, double lowerLimit, double upperLimit, int approach, PrinterCallbackPrx cb)
    {
        return printString(s, startTime, lowerLimit, upperLimit, approach, cb, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String printString(String s, long startTime, double lowerLimit, double upperLimit, int approach, PrinterCallbackPrx cb, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, startTime, lowerLimit, upperLimit, approach, cb, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> printStringAsync(String s, long startTime, double lowerLimit, double upperLimit, int approach, PrinterCallbackPrx cb)
    {
        return _iceI_printStringAsync(s, startTime, lowerLimit, upperLimit, approach, cb, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> printStringAsync(String s, long startTime, double lowerLimit, double upperLimit, int approach, PrinterCallbackPrx cb, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, startTime, lowerLimit, upperLimit, approach, cb, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_printStringAsync(String iceP_s, long iceP_startTime, double iceP_lowerLimit, double iceP_upperLimit, int iceP_approach, PrinterCallbackPrx iceP_cb, java.util.Map<String, String> context, boolean sync)
    {
