...
{
    default String printString(String s, double lowerLimit, double upperLimit, PrinterCallbackPrx cb)
    {
        return printString(s, lowerLimit, upperLimit, cb, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String printString(String s, double lowerLimit, double upperLimit, PrinterCallbackPrx cb, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, lowerLimit, upperLimit, cb, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> printStringAsync(String s, double lowerLimit, double upperLimit, PrinterCallbackPrx cb)
    {
        return _iceI_printStringAsync(s, lowerLimit, upperLimit, cb, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> printStringAsync(String s, double lowerLimit, double upperLimit, PrinterCallbackPrx cb, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, lowerLimit, upperLimit, cb, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_printStringAsync(String iceP_s, double iceP_lowerLimit, double iceP_upperLimit, PrinterCallbackPrx iceP_cb, java.util.Map<String, String> context, boolean sync)
    {
