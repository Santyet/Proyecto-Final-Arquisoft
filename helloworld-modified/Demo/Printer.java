...
{
    String printString(String s, long startTime, double lowerLimit, double upperLimit, int approach, PrinterCallbackPrx cb, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_printString(Printer obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        int iceP_approach;
        PrinterCallbackPrx iceP_cb;
        iceP_s = istr.readString();
        iceP_startTime = istr.readLong();
        iceP_lowerLimit = istr.readDouble();
        iceP_upperLimit = istr.readDouble();
        iceP_approach = istr.readInt();
        iceP_cb = PrinterCallbackPrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        String ret = obj.printString(iceP_s, iceP_startTime, iceP_lowerLimit, iceP_upperLimit, iceP_approach, iceP_cb, current);
