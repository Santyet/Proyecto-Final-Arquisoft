...
{
    String printString(String s, double lowerLimit, double upperLimit, PrinterCallbackPrx cb, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_printString(Printer obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        inS.endReadParams();
        String ret = obj.printString(iceP_s, iceP_lowerLimit, iceP_upperLimit, iceP_cb, current);
